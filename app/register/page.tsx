    ...
    <div className="min-h-screen bg-[#060c1a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center justify-center gap-2.5 mb-8">
          <svg viewBox="0 0 20 20" className="w-7 h-7 fill-current flex-shrink-0" style={{ color: '#f5a623', filter: 'drop-shadow(0 0 8px rgba(245,166,35,0.8))' }}>
            <path d="M10 2L12.4 7.5H18L13.3 11l1.9 5.8L10 13.5l-5.2 3.3L6.7 11 2 7.5h5.6z"/>
          </svg>
          <span className="font-black text-xl tracking-wide text-white" style={{ textShadow: '0 0 20px rgba(139,92,246,0.6)' }}>MLBB Counter</span>
        </div>

        {/* Card */}
        <div className="bg-[#0d1624] border border-purple-900/40 rounded-2xl p-8" style={{ boxShadow: '0 0 40px rgba(139,92,246,0.08)' }}>
          <h1 className="text-xl font-bold text-white mb-1">Create account</h1>
          <p className="text-sm text-gray-500 mb-6">Join MLBB Counter for free</p>
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4">
            ...
            <button
              ...
              style={{ background: 'linear-gradient(135deg, #7c3aed, #06b6d4)', boxShadow: loadingEmail ? 'none' : '0 0 20px rgba(124,58,237,0.4)' }}
            >
              {loadingEmail ? (
